...
function loadWeather(){
    ...
    if(zip === ''){zip = "28262"}
    var conditionsPath = "http://api.wunderground.com/api/841ffc4e5ff76f07/conditions/q/"+zip+".json";
    var forecastPath = "http://api.wunderground.com/api/841ffc4e5ff76f07/forecast/q/"+zip+".json";
    // GET THE CONDITIONS
